...
<div class='message'>
  <fieldset class='fieldset_basic'>
    <ul>
        ...
        %>
          <li class="li_none">
            <span class="span_fail">식당 등록에 실패했습니다.</span><br>
            등록 실패된 식당: <%=resname %>
          </li>
        <%  
          ...
          %>
          <li class='li_none'>
             <span class='span_success'>식당 삭제에 성공했습니다.</span><br>
             삭제된 식당: <%=resname %>
           </li>
           <%
           ...
           %>
           <li class='li_none'>
             <span class='span_fail'>식당 삭제에 실패했습니다.</span><br>
             삭제 실패된 식당: <%=resname %>
           </li>
           <%
          }
        ...
        <li class="li_none">
          ...
          if (cnt == 1) {
          %>
            <button type="button" onclick="location.href='./list_all.do'" class="btn btn-secondary btn-sm">식당 계속 등록</button>
          <%  
          } else {
          %>
