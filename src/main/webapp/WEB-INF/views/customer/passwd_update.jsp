  ...
  function send() {
    ...
    .then(rdata => {
      if (rdata.cnt == 0) { // 패스워드 검사, 불일치
        ...
        current_passwd_msg.innerHTML =""; // 기존에 실행되는 애니메이션 종료
...
<c:import url="/menu/top.do" />
  ...
  <form name='frm' id='frm' method='POST' action='./passwd_update.do'>
    ...
    <div id='new_passwd2_msg'></div>
  
    <div class="bottom_menu">
      <button type="button" id='btn_send' class="input_button_form input_submit btn-sm">변경</button>
