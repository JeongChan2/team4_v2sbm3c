...
<c:import url="/menu/top.do" />
  ...
  <form name='frm' id='frm' method='POST' action='./find_id.do'>
    ...
    <div class="form-floating mb-1 mt-3">
      <input type="text" class="form-control" id="cname" name="cname" placeholder="이름" autofocus="autofocus">
      <label for="current_passwd">이름</label>
    </div>

    <div class="form-floating mb-1 mt-3">
      <input type="text" class="form-control" id="tel" name="tel" placeholder="전화번호">
      <label for="new_passwd">전화번호</label>
    </div>

    <div class="bottom_menu">
      <button type="submit" id='btn_send' class="input_button_form input_submit btn-sm">찾기</button>
