    ...
    <ul>
      <c:choose>
        <c:when test="${param.code == 'create_success'}"> <%-- Java if --%>
          <li class='li_none'>
            <span class="span_success">${param.cname }님(${param.id }) 회원 가입을 축하합니다.</span>
          </li>  
          <li class='li_none'>
            <button type='button' 
        ...
        <c:when test="${param.code == 'update_success'}"> <%-- Java if --%>
          <li class='li_none'>
            <span class="span_success">${param.cname }님(아이디: ${param.id }) 회원 정보를 변경했습니다.</span>
          </li>
          <li class='li_none'>
            <button type='button' 
        ...
        <c:when test="${param.code == 'delete_success'}"> <%-- Java if --%>
          <li class='li_none'>
            <span class="span_success">${param.cname }님(${param.id }) 회원 정보 삭제에 성공했습니다.</span>
          </li>   
          <li class='li_none'>
            <button type='button' 
                         onclick="location.href='/customer/list.do'"
