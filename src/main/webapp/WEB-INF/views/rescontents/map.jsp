...
<c:import url="/menu/top.do" />
  ...
  <DIV class='title_line'><A href="/rescontents/list_by_resno.do?resno=${resVO.resno }" class="title_link">${resVO.resname }</A> > ${rescontentsVO.title } > 지도 등록/수정/삭제</DIV>
  ...
  <FORM name='frm_map' method='post' action='./map.do'>
    ...
    <div>
       <label>지도 스크립트</label>
       <textarea name='map' class="form-control" rows="12" style='width: 100%;'>${rescontentsVO.map }</textarea>
    </div>
  ...
  <DIV style="text-align: center;">
      ...
      <IMG src='/rescontents/images/map01.jpg' style='width: 60%;'><br><br>
      <IMG src='/rescontents/images/map02.jpg' style='width: 60%;'><br><br>
      <IMG src='/rescontents/images/map03.jpg' style='width: 60%;'><br><br>
      <IMG src='/rescontents/images/map04.jpg' style='width: 60%;'><br><br>
      <IMG src='/rescontents/images/map05.jpg' style='width: 60%;'><br>
  </DIV>
