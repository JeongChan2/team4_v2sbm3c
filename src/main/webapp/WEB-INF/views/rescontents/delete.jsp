...
<c:set var="thumb1" value="${rescontentsVO.thumb1.toLowerCase() }" />
...
<c:import url="/menu/top.do" />
  <DIV class='title_line'> ${resVO.resname } > ${title } >삭제</DIV>
...
<%--               <IMG src="/rescontents/storage/${file1saved }" style='width: 90%;'>  --%>

              <IMG src="/images/${file1saved }" style='width: 90%;'> 
            </c:when>
            <c:otherwise> <!-- 이미지가 없음 -->
               <IMG src="/rescontents/images/none1.png" style="width: 90%;"> 
            </c:otherwise>
          </c:choose>
        </DIV>
