...
ALTER TABLE RESTAURANT ADD typenum NUMBER(10);
ALTER TABLE RESTAURANT ADD foreign key(typenum) references FOODTYPE(typenum);

ALTER TABLE RESTAURANT ADD MANAGERNO NUMBER(10);
ALTER TABLE RESTAURANT ADD foreign key(MANAGERNO) references MANAGER(MANAGERNO);
