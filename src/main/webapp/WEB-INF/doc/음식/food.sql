...
ALTER TABLE FOOD ADD MANAGERNO NUMBER(10);
ALTER TABLE FOOD ADD foreign key(MANAGERNO) references MANAGER(MANAGERNO);

ALTER TABLE FOOD ADD RESNO NUMBER(10);
ALTER TABLE FOOD ADD foreign key(RESNO) references RESTAURANT(RESNO);
