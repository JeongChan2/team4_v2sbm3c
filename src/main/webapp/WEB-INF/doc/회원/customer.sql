...
VALUES (customer_seq.nextval, 'qnaadmin', '1234', '질문답변관리자', '000-0000-0000', '12345',
             '서울시 종로구', '관철동', sysdate, 1);
 
INSERT INTO customer(customerno, id, passwd, cname, tel, zipcode,
                                address1, address2, cdate, grade)
VALUES (customer_seq.nextval, 'crm', '1234', '고객관리자', '000-0000-0000', '12345',
             '서울시 종로구', '관철동', sysdate, 1);
 
-- 개인 회원 테스트 계정
INSERT INTO customer(customerno, id, passwd, cname, tel, zipcode, address1, address2, cdate, grade)
VALUES (customer_seq.nextval, 'user1@gmail.com', '1234', '왕눈이', '000-0000-0000', '12345', '서울시 종로구', '관철동', sysdate, 15);
 
INSERT INTO customer(customerno, id, passwd, cname, tel, zipcode, address1, address2, cdate, grade)
VALUES (customer_seq.nextval, 'user2@gmail.com', '1234', '아로미', '000-0000-0000', '12345', '서울시 종로구', '관철동', sysdate, 15);
 
INSERT INTO customer(customerno, id, passwd, cname, tel, zipcode, address1, address2, cdate, grade)
VALUES (customer_seq.nextval, 'user3@gmail.com', '1234', '투투투', '000-0000-0000', '12345', '서울시 종로구', '관철동', sysdate, 15);
 
-- 부서별(그룹별) 공유 회원 기준
INSERT INTO customer(customerno, id, passwd, cname, tel, zipcode, address1, address2, cdate, grade)
VALUES (customer_seq.nextval, 'team1', '1234', '개발팀', '000-0000-0000', '12345', '서울시 종로구', '관철동', sysdate, 15);
 
INSERT INTO customer(customerno, id, passwd, cname, tel, zipcode, address1, address2, cdate, grade)
VALUES (customer_seq.nextval, 'team2', '1234', '웹퍼블리셔팀', '000-0000-0000', '12345', '서울시 종로구', '관철동', sysdate, 15);
 
INSERT INTO customer(customerno, id, passwd, cname, tel, zipcode, address1, address2, cdate, grade)
VALUES (customer_seq.nextval, 'team3', '1234', '디자인팀', '000-0000-0000', '12345', '서울시 종로구', '관철동', sysdate, 15);
